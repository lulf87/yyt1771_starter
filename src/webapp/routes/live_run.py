...
def auto_detect_measurement_definition(
    ...
    return AutoDetectDefinitionResponse(
        ...
        configured_endpoint_support_radius_px=_metric_meta_float(metric, "configured_endpoint_support_radius_px"),
        effective_endpoint_support_radius_px=_metric_meta_float(metric, "effective_endpoint_support_radius_px"),
        configured_endpoint_min_support_px=_metric_meta_int(metric, "configured_endpoint_min_support_px"),
        effective_endpoint_min_support_px=_metric_meta_int(metric, "effective_endpoint_min_support_px"),
        endpoint_support_is_hard_reject=_metric_meta_bool(metric, "endpoint_support_is_hard_reject"),
        endpoint_support_mode=_metric_meta_str(metric, "endpoint_support_mode"),
        endpoint_support_reject_policy=_metric_meta_str(metric, "endpoint_support_reject_policy"),
        selected_candidate_score=_metric_meta_float(metric, "selected_candidate_score"),
        selected_width_extreme_mode=_metric_meta_str(metric, "selected_width_extreme_mode"),
        selected_candidate_span=_metric_meta_float(metric, "selected_candidate_span"),
        selected_candidate_axis_offset=_metric_meta_float(metric, "selected_candidate_axis_offset"),
        candidate_selection_goal=_metric_meta_str(metric, "candidate_selection_goal"),
