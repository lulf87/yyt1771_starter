...
class RunTelemetryPointResponse(BaseModel):
    ...
    observed_point_a_px: list[int] | None = None
    observed_point_b_px: list[int] | None = None
    observed_point_a_preview_px: list[int] | None = None
    observed_point_b_preview_px: list[int] | None = None
    observed_source_point_a_px: list[int] | None = None
    observed_source_point_b_px: list[int] | None = None
    observed_axis_point_a_px: list[int] | None = None
    observed_axis_point_b_px: list[int] | None = None
    observed_source_point_a_preview_px: list[int] | None = None
    observed_source_point_b_preview_px: list[int] | None = None
    observed_axis_point_a_preview_px: list[int] | None = None
    observed_axis_point_b_preview_px: list[int] | None = None
