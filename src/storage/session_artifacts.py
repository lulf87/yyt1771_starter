        ...
        with telemetry_path.open("w", encoding="utf-8", newline="") as handle:
            writer = csv.DictWriter(
                ...
                fieldnames=[
                    ...
                    "axis_point_a_px",
                    "axis_point_b_px",
                    "source_point_a_preview_px",
                    "source_point_b_preview_px",
                    "axis_point_a_preview_px",
                    "axis_point_b_preview_px",
                    "tracking_mode",
                    "tracking_state",
                    "selection_mode",
                    "reason",
                    ...
                    "endpoint_jump_px",
                    "midpoint_drift_px",
                    "midpoint_along_shift_px",
                    "midpoint_lateral_drift_px",
                    "span_change_px",
                    "span_change_ratio",
                    "max_frame_span_jump_px",
                    "max_soft_frame_span_jump_px",
                    "consecutive_misses",
                    "frame_read_ms",
                    "temp_read_ms",
                    "metric_extract_ms",
